...
- add ClickHouse adapter (#114) (#157)

### Fix

- grant contents:read to workflows that call reusable workflows
- resolve all code scanning security alerts (#147)
- preserve None values in to_dataframe for pandas 3.x StringDtype compatibility

## 0.22.1 (2026-03-02)

### Fix

- skip CTE alias check for qualified table names and make default_namespace optional (#143)
- remove worker log suffix and handle leading SQL comments before WITH clause (#142)
